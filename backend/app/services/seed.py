...
ITEMS = [
 ...
 ("A-008", "The Problem of the Rupee", "Book", "1923", "B. R. Ambedkar", "Economic study submitted at the University of London.", "economics, currency, rupee", "Currency stability requires institutions and policy attentive to the value of money and the interests of the public."),
...
EVENTS = [
 ...
 ("T-004","1923","The Problem of the Rupee","His economic study was published.",["A-008"]),
 ...
 ("T-013","1949-11-26","Constitution adopted","The Constituent Assembly adopted the Constitution of India.",["A-004"]),
